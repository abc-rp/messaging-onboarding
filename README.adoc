...
NOTE: The commands bellow are prefixed with the `$` character which represent the command prompt and should not be copied.
...
NOTE: It is likely that this process has been done for you are you can just skip the part where you export your tenant id.

Register a tenant using Hono’s Device Registry’s management HTTP API (a random tenant identifier will be generated):

[source,bash]
----
$ http --form POST http://$REGISTRY_IP:28080/v1/tenants

HTTP/1.1 201 Created
content-length: 45
content-type: application/json; charset=utf-8
etag: 62d8c518-cd1c-4ffb-a8bd-c4195259d417
location: /v1/tenants/ff9d317d-1ad9-4684-ac60-c20f0df91c9e

{
    "id": "ff9d317d-1ad9-4684-ac60-c20f0df91c9e"
}
----
...
[source,bash]
----
$ export MY_TENANT=ff9d317d-1ad9-4684-ac60-c20f0df91c9e
----
...
[source,bash]
----
$ http --form POST http://$REGISTRY_IP:28080/v1/devices/$MY_TENANT

HTTP/1.1 201 Created
content-length: 45
content-type: application/json; charset=utf-8
etag: e8045ecc-0b71-4002-bed0-15d0bd819535
location: /v1/devices/ff9d317d-1ad9-4684-ac60-c20f0df91c9e/a299435d-0d79-4035-9cb3-fae2c86125c8

{
    "id": "a299435d-0d79-4035-9cb3-fae2c86125c8"
}
----

[source,bash]
----
$ export MY_DEVICE=a299435d-0d79-4035-9cb3-fae2c86125c8
----
...
2020-11-16T16:49:38.050086463Z
----
...
$ mqtt pub -V 3 -h $MQTT_ADAPTER_IP -t telemetry \
  ...
  "version": 1,
  "timestamp": 2020-11-16T16:49:38.050086463Z,
  "points": {
    "supply_air_temperature_sensor": {
      "present_value": 20.30108642578125
    },
...
[source,bash]
----
16:56:36.499 [vert.x-eventloop-thread-0] INFO  org.eclipse.hono.cli.app.Receiver - received telemetry message [device: a299435d-0d79-4035-9cb3-fae2c86125c8, content-type: application/octet-stream]: {
  "version": 1,
  "timestamp": 2020-11-16T16:56:14.727953288Z,
  "points": {
    "supply_air_temperature_sensor": {
      "present_value": 20.30108642578125
    },
...
16:56:36.499 [vert.x-eventloop-thread-0] INFO  org.eclipse.hono.cli.app.Receiver - ... with application properties: {orig_adapter=hono-mqtt, device_id=a299435d-0d79-4035-9cb3-fae2c86125c8, qos=0, orig_address=telemetry}
----
...
$ mqtt pub -V 3 -h $MQTT_ADAPTER_IP -t event \
  ...
  "version": 1,
  "timestamp": 2020-11-16T17:06:30.429437466Z,
  "points": {
    "co2_alarm": {
      "present_value": true
    }
...
[source,bash]
----
17:07:55.981 [vert.x-eventloop-thread-0] INFO  org.eclipse.hono.cli.app.Receiver - received event message [device: a299435d-0d79-4035-9cb3-fae2c86125c8, content-type: application/octet-stream]: {
  "version": 1,
  "timestamp": 2020-11-16T17:06:30.429437466Z,
  "points": {
    "co2_alarm": {
...
17:07:55.981 [vert.x-eventloop-thread-0] INFO  org.eclipse.hono.cli.app.Receiver - ... with application properties: {orig_adapter=hono-mqtt, device_id=a299435d-0d79-4035-9cb3-fae2c86125c8, qos=1, orig_address=event}
----